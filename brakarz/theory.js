...
**Słoistość** to przeciętna szerokość przyrostów rocznych — mierzona na czole tarcicy na odcinku 75 mm wzdłuż linii promieniowej. Wąskie słoje (gęste drewno) oznaczają wyższą gęstość i wytrzymałość.`
      ,
        image: {
          src: 'assets/img/sloje_mikroskop.jpg',
          alt: 'Mikroskopowy przekrój 3-letniego pędu sosny (100×) - wyraźne drewno wczesne i późne w słojach rocznych',
          source: 'Wikimedia Commons',
          sourceUrl: 'https://commons.wikimedia.org/wiki/File:Gymnosperm_Stem_Annual_Rings_in_Three_Year_Pinus_(36323181745).jpg',
